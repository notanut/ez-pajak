...
<nav class="navbar navbar-expand-lg bg-body-tertiary bg-white shadow-sm">
    <div class="container px-4">
        <a class="navbar-brand d-flex align-items-center" href="/">
            ...
            <span class="ms-2 align-middle fs-4 fw-semibold ezpajak-color text-blue fst-italic">EZPajak</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            {{-- <div class="navbar-nav me-auto mb-2 mb-lg-0 ms-4"> <a class="nav-link active fs-5 me-3" aria-current="page" href="/jadwalkan-notifikasi/{pengguna}">Dashboard</a>
