                        ...
                        <div class="inner-right-section mt-2 mb-2">
                            ...
                            <form class="form-register">
                                ...
                                <div class="d-flex flex-column mb-3">
                                    ...
                                    <input type="email" class="form-setting border-setting rounded-0 shadow-none ps-0" id="email" placeholder="mail@domain.com">
                                </div>
                                <div class="d-flex flex-column mb-3">
                                    <label for="password" class="form-label fw-semibold text-primary m-0">Password</label>
                                    <input type="password" class="form-setting border-setting rounded-0 shadow-none ps-0" id="password" placeholder="Min. 8 karakter">
                                </div>
                                <div>
                                    <p><a href="" class="d-flex justify-content-end text-login fw-semibold text-decoration-none">Lupa Password?</a></p>
                                </div>
                                <div class="d-flex justify-content-center align-item center">
                                    <button type="submit" class="btn btn-primary fw-bold mt-3">Masuk</button>
                                </div>
                            </form>
                            <p class="text-center mt-3">Belum punya akun? <a href="#" class="text-login fw-semibold text-decoration-none">Daftar di sini</a></p>
                        </div>
                    </div>
