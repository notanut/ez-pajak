...
<section class="d-block d-md-flex gap-5 justify-content-evenly container py-4">
        <div class="left">
                ...
                <div class="form-wrap">
                    <div class="form-floating form-check input-field btn-group" role="group">
                        ...
                        <div class="radio-wrap">
                            <div class="opt">
                                {{-- Mengisi nilai radio button jika ada data bukanPegawai --}}
                                <input type="radio" name="dibayar_bulanan" value="0" id="dibayar-ya" {{ isset($bukanPegawai) && $bukanPegawai->dibayar_bulanan == 0 ? 'checked' : '' }}> Ya
                                <label for="dibayar-ya"></label>
                            </div>
                            <div class="opt">
                                <input type="radio" name="dibayar_bulanan" value="1" id="dibayar-tidak" {{ isset($bukanPegawai) && $bukanPegawai->dibayar_bulanan == 1 ? 'checked' : '' }}> Tidak
            ...
            <div class="card">
                ...
                <div class="form-wrap" id="tidakBulanan" style="display: {{ isset($bukanPegawai) && $bukanPegawai->dibayar_bulanan == 0 ? 'block' : 'none' }};">
                    <div class="form-floating input-field mb-0 mt-3">
                        <input class="form-control rp" id="floatingTerpotong" placeholder="0" value="{{ $bukanPegawai->total_bruto ?? '' }}">
                    ...
                    <div class="form-floating form-check input-field btn-group" role="group">
                        ...
                        <div class="radio-wrap">
                            <div class="opt">
                                {{-- Mengisi nilai radio button jika ada data bukanPegawai --}}
                                <input type="radio" name="pihak_ketiga" value="0" id="ketiga-ya" {{ isset($bukanPegawai) && $bukanPegawai->pihak_ketiga == 0 ? 'checked' : '' }}> Ya
                                <label for="ketiga-ya"></label>
                            </div>
                            <div class="opt">
                                <input type="radio" name="pihak_ketiga" value="1" id="ketiga-tidak" {{ isset($bukanPegawai) && $bukanPegawai->pihak_ketiga == 1 ? 'checked' : '' }}> Tidak
                    ...
                    <div id="yaPihak" style="display :{{ isset($bukanPegawai) && $bukanPegawai->pihak_ketiga == 0 ? 'block' : 'none' }};" class="form-floating input-field mb-0 mt-3">
                        <input class="form-control rp" id="floatingPihakKetiga" placeholder="0" value="{{ $bukanPegawai->biaya_pihak_ketiga ?? '' }}">
                ...
                <div class="form-wrap" id="bulanan" style="display: {{ isset($bukanPegawai) && $bukanPegawai->dibayar_bulanan == 1 ? 'block' : 'none' }};">
                    <div class="form-floating form-check input-field btn-group" role="group">
                            <p class="label">Apakah penghasilan setiap bulan Anda sama?</p>
                            <div class="radio-wrap">
                                <div class="opt">
                                    {{-- Mengisi nilai radio button jika ada data bukanPegawai --}}
                                    <input type="radio" name="bin" value="0" id="sama" {{ isset($bukanPegawai) && $bukanPegawai->bulanan_sama == 0 ? 'checked' : '' }}> Ya
                                    <label></label>
                                </div>
                                <div class="opt">
                                    <input type="radio" name="bin" value="1" id="tidakSama" {{ isset($bukanPegawai) && $bukanPegawai->bulanan_sama == 1 ? 'checked' : '' }}> Tidak
                                    <label></label>
                                </div>
                            </div>
                    </div>
                    <div id="tiapBulanSama" style="display: {{ isset($bukanPegawai) && $bukanPegawai->bulanan_sama == 0 ? 'block' : 'none' }};">
                        <div class="form-floating input-field mb-0 mt-3">
                            <input class="form-control rp" id="floatingGaji" placeholder="0" value="{{ $bukanPegawai->bruto_perbulan ?? '' }}">
                        ...
                        <div class="form-floating input-field mb-0 mt-3">
                            <input type="number" class="form-control" id="floatingInput" placeholder="2" min="1" max="12" value="{{ $bukanPegawai->banyak_bulan_bekerja ?? '' }}">
                    ...
                    <div id="tiapBulanBeda" style="display: {{ isset($bukanPegawai) && $bukanPegawai->bulanan_sama == 1 ? 'block' : 'none' }};">
                        ...
                        <div class="form-floating input-field mon">
                            <input class="form-control rp" id="Januari" placeholder="0" value="{{ $bukanPegawai->bruto_jan ?? '' }}">
                            <label for="Januari">Januari</label>
                        </div>
                        <div class="form-floating input-field">
                            <input class="form-control rp" id="Februari" placeholder="0" value="{{ $bukanPegawai->bruto_feb ?? '' }}">
                            <label for="Februari">Februari</label>
                        </div>
                        <div class="form-floating input-field">
                            <input class="form-control rp" id="Maret" placeholder="0" value="{{ $bukanPegawai->bruto_mar ?? '' }}">
                            <label for="Maret">Maret</label>
                        </div>
                        <div class="form-floating input-field">
                            <input class="form-control rp" id="April" placeholder="0" value="{{ $bukanPegawai->bruto_apr ?? '' }}">
                            <label for="April">April</label>
                        </div>
                        <div class="form-floating input-field">
                            <input class="form-control rp" id="Mei" placeholder="0" value="{{ $bukanPegawai->bruto_mei ?? '' }}">
                            <label for="Mei">Mei</label>
                        </div>
                        <div class="form-floating input-field">
                            <input class="form-control rp" id="Juni" placeholder="0" value="{{ $bukanPegawai->bruto_jun ?? '' }}">
                            <label for="Juni">Juni</label>
                        </div>
                        <div class="form-floating input-field">
                            <input class="form-control rp" id="Juli" placeholder="0" value="{{ $bukanPegawai->bruto_jul ?? '' }}">
                            <label for="Juli">Juli</label>
                        </div>
                        <div class="form-floating input-field">
                            <input class="form-control rp" id="Agustus" placeholder="0" value="{{ $bukanPegawai->bruto_agu ?? '' }}">
                            <label for="Agustus">Agustus</label>
                        </div>
                        <div class="form-floating input-field">
                            <input class="form-control rp" id="September" placeholder="0" value="{{ $bukanPegawai->bruto_sep ?? '' }}">
                            <label for="September">September</label>
                        </div>
                        <div class="form-floating input-field">
                            <input class="form-control rp" id="Oktober" placeholder="0" value="{{ $bukanPegawai->bruto_okt ?? '' }}">
                            <label for="Oktober">Oktober</label>
                        </div>
                        <div class="form-floating input-field">
                            <input class="form-control rp" id="November" placeholder="0" value="{{ $bukanPegawai->bruto_nov ?? '' }}">
                            <label for="November">November</label>
                        </div>
                        <div class="form-floating input-field">
                            <input class="form-control rp" id="Desember" placeholder="0" value="{{ $bukanPegawai->bruto_des ?? '' }}">
        ...
        <div class="right">
            <div class="card">
                ...
                <div class="form-wrap" id="bulanan-sama-wrap" style="display: {{ isset($bukanPegawai) && $bukanPegawai->dibayar_bulanan == 1 && $bukanPegawai->bulanan_sama == 0 ? 'block' : 'none' }};">
                    <div class="res-field">
                        <p class="label">Metode Penghitungan</p>
                        <p class="res" id="metodeHitungSama">{{ $bukanPegawai->metode_penghitungan ?? '-' }}</p>
                    </div>
                    <div class="res-field">
                        <p class="label">Tarif Pajak Progresif yang Dikenakan</p>
                        <p class="res">{{ $bukanPegawai->tarif ?? '-' }}</p>
                    ...
                    <div class="res-field">
                        ...
                        <p class="res" id="pphRataSama">Rp {{ number_format($bukanPegawai->pph21_perbulan ?? 0, 2, ',', '.') }}</p>
                    </div>
                </div>
                <div class="form-wrap" id="bulanan-beda-wrap" style="display: {{ isset($bukanPegawai) && $bukanPegawai->dibayar_bulanan == 1 && $bukanPegawai->bulanan_sama == 1 ? 'block' : 'none' }};">
                    <div class="res-field">
                        <p class="label">Metode Penghitungan</p>
                        <p class="res" id="metodeHitungBeda">{{ $bukanPegawai->metode_penghitungan ?? '-' }}</p>
                    </div>
                    <p class="label tiapBulan">PPh 21 Anda di Bulan..</p>
                    {{-- PPh 21 per bulan (jika ada) --}}
                    @if(isset($bukanPegawai))
                        @foreach(['jan', 'feb', 'mar', 'apr', 'mei', 'jun', 'jul', 'agu', 'sep', 'okt', 'nov', 'des'] as $month)
                            @if($bukanPegawai->{"pajak_{$month}"} !== null)
                                <div class="res-field">
                                    <p class="label">{{ ucfirst($month) }}</p>
                                    <p class="res">Rp {{ number_format($bukanPegawai->{"pajak_{$month}"}, 2, ',', '.') }}</p>
                                </div>
                            @endif
                        @endforeach
                    @endif
                </div>
                <div class="form-wrap" id="tidak-bulanan-wrap" style="display: {{ isset($bukanPegawai) && $bukanPegawai->dibayar_bulanan == 0 ? 'block' : 'none' }};">
                    <div class="res-field">
                        <p class="label">Penghasilan Neto</p>
                        <p class="res" id="netoTidakBulanan">Rp {{ number_format($bukanPegawai->penghasilan_neto ?? 0, 2, ',', '.') }}</p>
                        <div class="tooltip-container hasil">
                            <span class="tooltip-circle">?</span>
                            <div class="tooltip-content">
                    ...
                    <div class="res-field">
                        <p class="label">Metode Penghitungan</p>
                        <p class="res">{{ $bukanPegawai->metode_penghitungan ?? '-' }}</p>
                    </div>
                    <div class="res-field">
                        <p class="label">Tarif Pajak Progresif yang Dikenakan</p>
                        <p class="res">{{ $bukanPegawai->tarif ?? '-' }}</p>
                ...
                <div class="total grand mt-3">
                    ...
                    <p class="rp-total">Rp {{ number_format($bukanPegawai->pph21_terutang ?? 0, 2, ',', '.') }}</p>
                </div>
            </div>
...
@push('scripts')
    {{-- Mengirimkan data transaksi dan bukanPegawai ke JavaScript --}}
    <script>
        window.bukanPegawaiData = @json($bukanPegawai ?? null);
