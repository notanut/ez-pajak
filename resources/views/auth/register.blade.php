                        ...
                        <div class="inner-left-section mt-2 mb-2">
                            <div class="content-top">
                                <div>
                                    ...
                                    <img class="register-illustration" src="{{ asset('images/login_register_illust.svg') }}" alt="Illustration">
                                </div>
                            </div>
                            <div class="mt-4 d-flex justify-content-evenly align-item-center gap-5">
                                <img src="{{ asset('img/ic_baseline-facebook.png') }}" alt="Facebook">
                                <img src="{{ asset('img/mdi_instagram.png') }}" alt="Instagram">
                                <img src="{{ asset('img/devicon_twitter.png') }}" alt="X">
                                <img src="{{ asset('img/mdi_linkedin.png') }}" alt="LinkedIn">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="inner-right-section mt-2 mb-2">
                            ...
                            <form class="form-register" action="{{route('register')}}" method="POST">
                                ...
                                <div class="d-flex flex-column mb-3">
                                    <label for="name" class="form-label fw-semibold text-primary m-0">Nama Lengkap</label>
                                    <input type="text" class="form-setting border-setting rounded-0 shadow-none ps-0" 
                                        value="{{ old('name') }}" name="name" id="name" 
                                        placeholder="Daftarkan nama lengkap kamu" 
                            ...
                            <p class="text-center mt-3">Sudah punya akun? <a href="{{ route('login') }}" class="text-login fw-semibold text-decoration-none">Masuk di sini</a></p>
                        </div>
                    </div>
                </div>
            </div>
